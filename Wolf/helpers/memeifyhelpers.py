...
async def wolf_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def drg_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = drgimage(filename=picture_name)
    main_image.resize(
