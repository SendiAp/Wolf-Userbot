...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/SendiAp/Wolf-Userbot.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "wolfuserbot")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/f68ac79cb5f0f8b84bc5f.jpg"
    )
    ...
    CMD_HANDLER = os.environ.get("COMMAND_HAND_LER", r".")
    SUDO_CMD_HANDLER = os.environ.get("SUDO_COMMAND_HAND_LER", r".")
